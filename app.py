...
# Update API keys and model paths (edit by AI)

# --- API KEYS ---
import dotenv

HF_TOKEN = os.getenv("HUGGINGFACE_LOGIN_TOKEN") or "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"
OPEN_WEATHER_APIKEY = os.getenv("OPEN_WEATHER_APIKEY") or "9b95bbef4bee58f0a5728cf56182ecf2"

# --- Model paths for local models ---
CROP_RECOMMENDATION_MODEL_PATH = "models/RandomForest.pkl"
SOIL_TYPE_PREDICTION_MODEL_PATH = "models/DenseNet121v2_95.h5"
SOIL_NET_MODEL_PATH = "models/SoilNet_93_86.h5"
FERTILIZER_CSV = 'data/fertilizer.csv'

# Standardize and simplify all model/data file loading paths
CROP_RECOMMENDATION_MODEL_PATH = "models/RandomForest.pkl"
SOIL_TYPE_PREDICTION_MODEL_PATH = "models/DenseNet121v2_95.h5"
SOIL_NET_MODEL_PATH = "models/SoilNet_93_86.h5"
FERTILIZER_CSV = 'data/fertilizer.csv'

# Define loader before any usage
...
# Always use these explicit, direct assignments
crop_recommendation_model = pickle.load(open(CROP_RECOMMENDATION_MODEL_PATH, 'rb'))
soil_model = load_model_safely(SOIL_TYPE_PREDICTION_MODEL_PATH)
SoilNet = load_model_safely(SOIL_NET_MODEL_PATH)

# Later for fertilizer in the fert_recommend route:
# df = pd.read_csv(FERTILIZER_CSV)

# Use these API keys wherever required:
weather_api_key = OPEN_WEATHER_APIKEY

# When using HuggingFace or transformers pipeline, pass the HF_TOKEN as needed.
...
model_path = SOIL_NET_MODEL_PATH
...
def crop_recommend():
    title = 'KisaanHub - Crop Recommendation'
    return render_template('crop.html', title=title)


@app.route('/soil-predict', methods=['POST'])
def soil_prediction():
    title = 'KisaanHub - Soil Prediction'
...
def fertilizer_recommendation():
    title = 'KisaanHub - Fertilizer Suggestion'
...
def disease_prediction():
    title = 'KisaanHub - Disease Detection'
